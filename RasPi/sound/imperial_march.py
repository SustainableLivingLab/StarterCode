...
melody = [
    ...
    (NOTES['A4'], 4), (NOTES['A4'], 4), (NOTES['A4'], 4), (NOTES['F4'], -8), (NOTES['C5'], 16),
    (NOTES['A4'], 4), (NOTES['F4'], -8), (NOTES['C5'], 16), (NOTES['A4'], 2),
    (NOTES['E5'], 4), (NOTES['E5'], 4), (NOTES['E5'], 4), (NOTES['F5'], -8), (NOTES['C5'], 16),
    (NOTES['A4'], 4), (NOTES['F4'], -8), (NOTES['C5'], 16), (NOTES['A4'], 2),
    (NOTES['A5'], 4), (NOTES['A4'], -8), (NOTES['A4'], 16), (NOTES['A5'], 4), (NOTES['GS5'], -8), (NOTES['G5'], 16),
    (NOTES['DS5'], 16), (NOTES['D5'], 16), (NOTES['DS5'], 8), (REST, 8), (NOTES['A4'], 8), (NOTES['DS5'], 4), (NOTES['D5'], -8), (NOTES['CS5'], 16),
    (NOTES['C5'], 16), (NOTES['B4'], 16), (NOTES['C5'], 16), (REST, 8), (NOTES['F4'], 8), (NOTES['GS4'], 4), (NOTES['F4'], -8), (NOTES['A4'], -16),
    (NOTES['C5'], 4), (NOTES['A4'], -8), (NOTES['C5'], 16), (NOTES['E5'], 2),
    (NOTES['A5'], 4), (NOTES['A4'], -8), (NOTES['A4'], 16), (NOTES['A5'], 4), (NOTES['GS5'], -8), (NOTES['G5'], 16),
    (NOTES['DS5'], 16), (NOTES['D5'], 16), (NOTES['DS5'], 8), (REST, 8), (NOTES['A4'], 8), (NOTES['DS5'], 4), (NOTES['D5'], -8), (NOTES['CS5'], 16),
    (NOTES['C5'], 16), (NOTES['B4'], 16), (NOTES['C5'], 16), (REST, 8), (NOTES['F4'], 8), (NOTES['GS4'], 4), (NOTES['F4'], -8), (NOTES['A4'], -16),
    (NOTES['A4'], 4), (NOTES['F4'], -8), (NOTES['C5'], 16), (NOTES['A4'], 2),
